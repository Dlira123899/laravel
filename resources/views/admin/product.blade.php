                ...
                <div class="card-body pb-0">
                  ...
                  <form id="form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <button type="submit" class="submitForm btn btn-primary">Submit Form</button>
                      </div>
                    </div>
                  </form>
                </div>
        ...
        $.ajax({
          ...
          success: function(res) {
            ...
            if (!res.status) {
              ...
              errhtml += res.message;
              errhtml += '</div>';
              $("#error-alert").html(errhtml);
            } else {
              var successhtml = '<div class="alert alert-success alert- alert-dismissible fade show" role="alert"><i class="bi bi-exclamation-octagon me-1"></i>';
              successhtml += res.message;
              successhtml += '</div>';
              $("#error-alert").html(successhtml);
            }
          },
